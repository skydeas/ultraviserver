    ...
    jwt.verify(req.headers.logintoken, config.privateKey, (err, decoded) => {
        ...
        connectionPool.query(
            `UPDATE ${databaseName} SET 
                ...
                actual_arrival_time=${req.body.actual_arrival_time === '' ? 'NULL' : req.body.actual_arrival_time},
                actual_departure_time=${req.body.actual_departure_time === '' ? 'NULL' : req.body.actual_departure_time}, 
                ...
                estimated_arrival_time=${req.body.estimated_arrival_time === '' ? 'NULL' : req.body.estimated_arrival_time}, 
                estimated_departure_time=${req.body.estimated_departure_time === '' ? 'NULL' : req.body.estimated_departure_time}, 
